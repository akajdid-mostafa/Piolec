...
export const DEFAULT_KEYWORDS = [
  ...
  "vidéosurveillance Maroc",
  "systèmes de sécurité",
  "pré-câblage informatique Maroc",
  "maintenance électrique industrielle",
  "armoires électriques Maroc",
  "électricien Casablanca",
  "électricien Agadir",
  "installation électrique Casablanca",
  "installation électrique Agadir",
  "électricien industriel Maroc",
  "PIOLEC",
];
...
/**
 * Generates a JSON-LD Service schema for a specific PIOLEC service page.
 * @param {{ name: string, description: string, path: string, keywords?: string[] }} options
 */
export function createServiceJsonLd({ name, description, path, keywords = [] }) {
  return {
    "@context": "https://schema.org",
    "@type": "Service",
    name,
